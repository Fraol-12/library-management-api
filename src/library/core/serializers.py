...
class BookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Book
        fields = ['id', 'title', 'author', 'isbn', 'description', 'created_at', 'updated_at', 'is_available']
...
class LoanDetailSerializer(serializers.ModelSerializer):
    ...
    user = serializers.PrimaryKeyRelatedField(read_only=True)  # or serializers.StringRelatedField() for username

    class Meta:
        model = Loan
        fields = [
            'id', 'book', 'user', 'borrowed_at', 'due_date',
            'returned_at', 'is_active', 'is_overdue'
        ]
        read_only_fields = [
            'id', 'user', 'borrowed_at', 'returned_at', 'is_active', 'is_overdue'
        ]